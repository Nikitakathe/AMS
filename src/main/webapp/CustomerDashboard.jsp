  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
            <li><a class="nav-link scrollto active" href="CustomerDashboard.jsp">Home</a></li>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets\img\testimonials\jacket.jpg" class="testimonial-img" alt="">
                <h3>Jacket</h3>
                <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/testimonials/laptop.jpg" class="testimonial-img" alt="">
                <h3>Laptop</h3>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                   Eat, Bid, Win, Repeat
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/testimonials/bike.jpeg" class="testimonial-img" alt="">
                <h3>Bike</h3>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/testimonials/home.jpeg" class="testimonial-img" alt="">
                <h3>Home</h3>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/testimonials/car.jpg" class="testimonial-img" alt="">
                <h3>Car</h3>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
