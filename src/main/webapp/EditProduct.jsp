...
String benddate=(String)request.getParameter("benddate");
String imgname=(String)request.getParameter("imgname");
String category=(String)request.getParameter("category");
String path=(String)request.getParameter("path");
String bstartdate=(String)request.getParameter("bstartdate");
%>
    ...
    <div class="main-panel" id="main-panel">
      ...
      <form action="edit_product" method="post">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="productname" value="<%=name%>" style="border-radius:5px;" class="form-control" id="exampleFormControlInput1">
        </div>
            <div class="form-group col-md-4">
        ...
        try{
         ...
         <div class="form-group col-md-12">
            ...
            <textarea class="form-control" name="description" style="border-radius:5px; border:1px solid #D3D3D3;" value="<%=desc%>" id="exampleFormControlTextarea1" rows="3"><%=desc%></textarea>
            </div>
           <div class="form-group  d-flex">
             <div class="form-group col-md-4">
            <label for="exampleFormControlInput1">Regular Price</label>
            <input type="number"  value="<%=rprice%>" name="regularprice" style="border-radius:5px;" class="form-control" id="exampleFormControlInput1" >
        </div>
            <div class="form-group col-md-4">
            <label for="exampleFormControlInput1">Starting Bidding Price</label>
            <input type="number"  value="<%=sbid%>" name="biddingprice" style="border-radius:5px;" class="form-control" id="exampleFormControlInput1" >
        </div>
            </div>
             <div class="form-group  d-flex">
                <div class="form-group col-md-4">
                    ...
                    <input type="datetime-local"  value="<%=bstartdate%>" name="bstartdate" style="border-radius:5px;" class="form-control bg-white">
                      
                    
                </div>
                 <div class="form-group col-md-4">
                    <label for="exampleFormControlInput1">Bidding End Date/Time</label>
                    <input type="datetime-local"  value="<%=benddate%>" name="benddate" style="border-radius:5px;" class="form-control bg-white">
                </div>
            </div>
                
                      <figure class="image-container">
            <img id="chosen-image" src="assets/img/Products/<%=imgname%>">
